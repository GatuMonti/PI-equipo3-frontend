...
import {
  ...
  hasClass,
  removeClass
} from "./chunk-NVHFAXPU.js";
import {
  require_warning
} from "./chunk-JQE5FQFZ.js";
import "./chunk-BZ3J2XGS.js";
import {
  require_classnames
...
var Modal2 = React76.forwardRef(({
  ...
  const renderBackdrop = (0, import_react31.useCallback)((backdropProps) => (0, import_jsx_runtime79.jsx)("div", {
    ...backdropProps,
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react35.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react36.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React87.forwardRef(({
  ...
  const renderBackdrop = (0, import_react37.useCallback)((backdropProps) => (0, import_jsx_runtime90.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React91.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames73.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime96.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime96.jsx)(Dropdown_default.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react42.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime107.jsxs)(import_jsx_runtime106.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react44.cloneElement)(children, triggerProps), (0, import_jsx_runtime105.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ToastFade = React117.forwardRef((props, ref) => (0, import_jsx_runtime128.jsx)(Fade_default, {
  ...props,
  ref,
