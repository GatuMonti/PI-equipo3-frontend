  ...
  return (
    <div>
        ...
        <form className="formularioAddProducto">
            ...
            <input className="inputCategoria" placeholder="Categoria" value={productoNuevo.category} onChange={handleOnchangeCategoria}/>
            <input className="inputDescripcion" placeholder="Descripcion" value={productoNuevo.description} onChange={handleOnchangeDescripcion}/>
            ...
            <input className="inputConsola" placeholder="Consola" value={productoNuevo.console} onChange={handleOnchangeConsola}/>
